...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Combo Sản phẩm Danh sách',
  'LBL_MODULE_NAME' => 'Combo Sản phẩm',
  'LBL_MODULE_TITLE' => 'Combo Sản phẩm',
  'LBL_HOMEPAGE_TITLE' => 'Của tôi Combo Sản phẩm',
  'LNK_NEW_RECORD' => 'Tạo Combo Sản phẩm',
  'LNK_LIST' => 'Xem Combo Sản phẩm',
  'LNK_IMPORT_SGGT_COMBO_COMPOENT' => 'Import Combo Sản phẩm',
  'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm Combo Sản phẩm',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Xem lịch sử',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Hoạt động',
  'LBL_SGGT_COMBO_COMPOENT_SUBPANEL_TITLE' => 'Combo Sản phẩm',
  'LBL_NEW_FORM_TITLE' => 'Mới Combo Sản phẩm',
  'LBL_PRODUCT_PARENT' => 'Sản phẩm cha',
  'LBL_PRODUCT_COMPONENT_AOS_PRODUCTS_ID' => 'Sản phẩm thành phần',
  'LBL_PRODUCT_COMPONENT' => 'Sản phẩm thành phần',
  'LBL_QUANTITY' => 'Số lượng',
  'LBL_STANDARD_PRICE' => 'Giá niêm yết',
  'LBL_SUBTOTAL' => 'Thành tiền sản phẩm',
  'LNK_IMPORT_SGGT_COMBO_COMPONENT' => 'Import Combo Sản phẩm',
  'LBL_SGGT_COMBO_COMPONENT_SUBPANEL_TITLE' => 'Combo Sản phẩm',
);